...
type _CoercedEnvSchema_c8f8b452 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_c8f8b452> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_c8f8b452, 'CI' | 'DB_HOST' | 'DB_NAME' | 'DB_PORT' | 'DB_USER' | 'PORT'>> {}
}
...
type _EnvSchemaAsStrings_c8f8b452 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_c8f8b452 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_c8f8b452 {}
  }
}